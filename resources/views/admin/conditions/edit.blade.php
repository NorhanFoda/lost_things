        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        {{-- @include('alert') --}}
                        <form class="form form-horizontal needs-validation" novalidate method="post" enctype="multipart/form-data" action="{{route('conditions.update', $con->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea type="text" class="form-control" placeholder="{{trans('admin.text')}}" rows="4" name="text" required>
                                                    {{$con->text}}
                                                </textarea>
