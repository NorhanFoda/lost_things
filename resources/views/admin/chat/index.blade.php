		...
		firebase.database().ref('/messages').on('value', function(snapshot) {
			...
			if(snapshot.val() != null) {
                ...
                for(let index in shot){
                    // var chat_name = escapeHtml(shot[index].id),
                    // var chat_name = shot[index].id,
					...
					if(shot[index].user_id == '{{auth()->user()->id}}'){
						$('.chat-item-right').addClass('pull-right');
						var caht_item = $(".chat-item-right").html(chat_element);
					}
					else{
						$('.chat-item-left').addClass('pull-left');
						var caht_item = $(".chat-item-left").html(chat_element);
					}

					$('card-body').append(caht_item);
				}
