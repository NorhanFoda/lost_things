        ...
        <ul class="nav navbar-nav text-center">
            <li class="dropdown dropdown-language nav-item" style="max-width: 150px;
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                    @if(app()->getLocale() == 'ar')
                        <a class="dropdown-item" href="{{route('change_locale','en')}}" data-language="en"><i class="flag-icon flag-icon-us"></i> English</a>
                    @else
                        <a class="dropdown-item" href="{{route('change_locale','ar')}}" data-language="ar"><i class="flag-icon flag-icon-sa"></i> العربية</a>
                    @endif
                </div>
            </li>
        </ul>
                                    ...
                                    <div class="card-body pt-1">
                                        <form action="{{ route('dashboard') }}" method="post">
                                            ...
                                            <div class="form-group d-flex justify-content-between align-items-center">
                                                ...
                                                {{-- <div class="text-left"><a href="{{ route('password.request') }}" class="card-link">{{trans('admin.forget')}}</a></div> --}}
                                                </div>
